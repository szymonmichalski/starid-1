...
star images from pointing vectors. two coordinates are independent and expressed in a plane tangent to the sky and its image in a sensor. shift so the central star is at the exact center of the image and then identify it.
