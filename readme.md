...
*recurrent neural network, rnn* - recurrent networks are about sequential processing and patterns in sequential data. they’re natural for time series and time varying systems. sequences may be an indirect perspective for star images, but we're concerned with randomly rotated star images. rotations should not effect image sequences, giving rnns an advantage for star identification, and here they were first to be capable of identifying thousands of stars.
