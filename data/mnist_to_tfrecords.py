...
def main(argv):
  images = read_images('/home/noah/dev/starid/data/images_a1.mnist')
  labels = read_labels('/home/noah/dev/starid/data/images_a2.mnist')
  convert_to_tfrecords(images, labels, '/home/noah/dev/starid/data/images_a.tfrecords')
  # imgndx = 0
