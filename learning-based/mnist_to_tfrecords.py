...
def main(argv):
  images = read_images('/home/noah/starid/data/images_b1.mnist')
  labels = read_labels('/home/noah/starid/data/images_b2.mnist')
  convert_to_tfrecords(images, labels, '/home/noah/starid/data/images_b.tfrecords')
  # imgndx = 0
