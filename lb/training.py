...
tf.app.flags.DEFINE_string('ckpt', '/home/noah/starid/lb/models/model.ckpt', '')
tf.app.flags.DEFINE_string('examples', '/home/noah/starid/stars/data/images_a.tfrecords', '')
