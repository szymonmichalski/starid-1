...
ML is beginning to explore a frontier referred to as attention. One perspective on this is, increased emphasis on vectorized, dot product based, numerical parallelization of decision processes. Attention is about dot products between tensors to determine significance.
