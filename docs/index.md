...
with lots of contemplation and reading over a two week vacation in texas, there's an [overall picture of what star identification as neural machine translation looks like](https://www.linkedin.com/pulse/small-deltas-from-neural-machine-translation-noah-smith/). and this is a good place to mention that as implementation picks up speed, tensorflow will now be joined by keras in the tool stack.
...
here's three rows of an info for starndx 3, showing starndxs 10, 27, and 38, and plot of all info pixels
