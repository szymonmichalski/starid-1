...
def main(argv):
  images = read_images('/home/noah/dev/mnist_initial_images.mnist')
  labels = read_labels('/home/noah/dev/mnist_initial_labels.mnist')
  convert_to_tfrecords(images, labels, '/home/noah/dev/mnist_initial.tfrecords')
